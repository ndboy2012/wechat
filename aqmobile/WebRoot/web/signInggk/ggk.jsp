...
<script src="../../js/signInggk/jQueryRotate.js" type="text/javascript"></script>
<script src="../../js/signInggk/jquery.easing.min.js"></script>
<script src="../../js/signInggk/jscroller-0.4.js" type="text/javascript"></script>
<script src="../../js/signInggk/wScratchPad.js" type="text/javascript"></script>
<script src="../../js/signInggk/alert.js" type="text/javascript"></script>
<script type="text/javascript" src="../../js/signInggk/lottery_ggk.js"></script>
...
<body data-role="page" class="activity-scratch-card-winning">
	...
	<div class="main">
		<div class="cover">
			<img src="../../images/signInggk/activity-scratch-card-bannerbg.png">
			<!-- 显示刮开后显示的东西 -->
			<div id="prize"></div>  
		...
		<script type="text/javascript">
			$(function() {
				$.ajax({							
					...
					url : "wechatSignController/listPrizeInfo.do?",//调用接口
							dataType : "json",
					   ...
					   <tbody>
							<tr>
								<td width="140" align="center" valign="middle" class="activity-lottery-btn">
									...
									<td width="140" align="center" valign="middle" class="activity-lottery-btn">
									    <a href="showPrizes.jsp?openid=<%=request.getParameter("openid")%>" id="link_prizeRecord" style="display:block;width:110px; height:26px">我的奖品</a>
									</td>
								</tr>
				     </tbody>
		          </table>
