...
<html>
  ...
  <body>
    <t:formvalid formid="formobj" dialog="true"
		layout="table" action="upperItemController.do?articleSave">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1"
			...
			<tr>
			     <td align="center"><label class="Validform_label">是否上传附件:
				</label></td>
				<td class="value">
				   <input type="checkbox" name="addFiles" value="1">是
				   <input type="hidden" id="files" name="files" value="0">
				</td>
			...
			<tr>
				...
				<td class="value"><input class="inputxt" id="sort" value="1" name="sort"
					...
					class="Validform_checktip"></span>默认为1</td>
			</tr>
			<tr>
	...
	$("#formobj").Validform(
			{
				...
				beforeSubmit : function(form) {
					...
					var items = $("input[name='addFiles']:checked");
					var result = "";
