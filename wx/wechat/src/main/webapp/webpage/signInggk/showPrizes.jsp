...
<script src="${webRoot}/js/signInggk/jquery.pager.js" type="text/javascript"></script>
<style type="text/css">
...
body {
	...
	margin-right: 0px;
	margin-bottom: 0px;
	background-image: url(../../files/images/sign/activity-scratch-card-bg.jpg);
}
...
<body>
	...
	<table width="320" border="0" align="center" cellpadding="0"
		cellspacing="0">
		<tr>
			<td height="100"><img src="${webRoot}/files/images/sign/top1.jpg" width="320" height="100" /></td>
		</tr>
		<tr>
				...
				<script type="text/javascript">
					$(function() {
						...
						function queryOrderInfo(pageclickednumber) {
							...
							$.ajax({									
								        url : "listSinglePrizeInfo.do",//调用接口	
								        type : "get",
										dataType : "json",
