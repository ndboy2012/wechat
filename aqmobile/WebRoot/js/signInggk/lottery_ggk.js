...
$(function() {
	  ...
	  $.ajax({		 
		    url: "wechatSignController/flashLoginVerify.do?open_id="+$('#txt_mobile').val(),
		    type:"get",
		    dataType: "json",    
	...
	$.ajax({
		url : "wechatSignController/registerInfo.do?open_id="+ $('#txt_mobile').val(),// 调用接口
		type : 'get',
		dataType : "json",
	...
	function ajaxPrize() {
		$.ajax({
			url : "wechatSignController/newRandomPrize.do?open_id="+ $('#txt_mobile').val(),// 调用接口
			dataType : "json",
			success : function(data) {
				 ...
				 */
				$.ajax({		
					url : "wechatSignController/updatePrizeInfo.do?openid="+ $('#txt_mobile').val(),// 调用接口
					dataType : "json",
					success : function(data) {
