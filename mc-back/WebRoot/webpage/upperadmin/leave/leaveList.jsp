				...
				.datagrid(
						{
							idField : 'id',
							title : '留言信息',
							url : 'upperLeaveController.do?datagrid&field=id,sources,target,content,isHandle,createTime,',
							fit : true,
							loadMsg : '数据加载中...',
							pageSize : 10,
							pagination : true,
							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value,rec,index) {
											return "<div style='width:420px' class='overflow'>"+value+"</div>";
										} 
									},
									{
										field : 'isHandle',
...
<script type="text/javascript">
  function mark(id) {
	  $.ajax({
		  url:"upperLeaveController.do?mark",
	      dataType:"json",
	      type:"get",
	      data:{
	    	"id":id,  
