				...
				.datagrid(
						{
							idField : 'id',
							title : '通告信息',
							url : 'upperLeaveController.do?mydatagrid&field=id,property,sources,target,content,isHandle,createTime,',
							fit : true,
							loadMsg : '数据加载中...',
							pageSize : 10,
							pagination : true,
							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value,rec,index) {
											return "<div style='width:420px'>"+value+"</div>";
										} 
									},
									{
										field : 'isHandle',
...
<div id="leaveListtb" style="padding:3px; height: auto">
	<div style="height:30px;" class="datagrid-toolbar">
		...
		<a href="#" class="easyui-linkbutton" plain="true" icon="icon-reload" onclick="refresh()">刷新 </a>
		<a href="#"
			class="easyui-linkbutton" plain="true" icon="icon-add"
			onclick="add('录入','upperLeaveController.do?addorupdate','leaveList',null,null)">录入区域通告</a>
			<a href="#"
			class="easyui-linkbutton" plain="true" icon="icon-add"
			onclick="add('录入','upperLeaveController.do?publicMsg','leaveList',null,null)">录入公共通告</a><a
