				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="districtName" name="districtName" 
							   value="${districtPage.districtName}" datatype="*" disabled="disabled">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="email" name="email" ignore="ignore"
							   value="${districtPage.email}" disabled="disabled">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="telephone" name="telephone" ignore="ignore"
							   value="${districtPage.telephone}" disabled="disabled">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="address" name="address" 
							   value="${districtPage.address}" datatype="*" disabled="disabled">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
