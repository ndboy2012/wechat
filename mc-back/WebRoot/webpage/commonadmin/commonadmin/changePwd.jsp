...
<body style="overflow-y: hidden" scroll="no">
	...
	<form id="formobj" action="commonAdminController.do?changePassword"
		layout="table">
		<input id="id" name="id" type="hidden" value="${admin_session.id}">
		<table style="width:100%" cellpadding="0" cellspacing="1"
			...
			<tbody>
				<tr>
					...
					<span id="username" name="username" ignore="ignore" value="${admin_session.username}"
						readonly> <font size="18"><a>${admin_session.username}</a></font></span>
					</td>
				</tr>
				<tr>
