...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
			...
			<tbody>
				<tr>
					<td align="left" style="vertical-align: text-bottom"><img
						...
						style="float:left;margin-top:8px;margin-left:10px;width:12%" /></td>
					<td align="right" nowrap="">
						<table border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr style="height: 25px;" align="right">
									<td
										style="width:100%;background: url(${webRoot}/plug-in/login/images/top_bg.jpg) no-repeat right center;"
										colspan="3">
										<div>
											...
											<div
												...
												<span style="color: #386780">当前用户:</span> <span
													style="color: #FFFFFF">${admin_session.username}</span>&nbsp;&nbsp;&nbsp;&nbsp;
												<span style="color: #386780">单位:</span> <span
													style="color: #FFFFFF">${admin_session.district.districtName}</span>
													<span style="color: #386780">角色:</span> <span
													style="color: #FFFFFF">${admin_session.role}</span>
													<span
													style="color: #FFFFFF"><a href="javascript:void(0)" target= _blank onclick="enterBefore()">进入前台</a></span>
											</div>
										</div>
									</td>
								</tr>
								<tr style="height: 80px;float: right;">
									<td colspan="2" style="position:relative;left:0px">
										<ul class="shortcut" id="shortcut-bd">
											<!-- 动态生成并赋值过来 -->
											<li><img class="imag1"
												src="${webRoot}/plug-in/login/images/defaultuserinfo.png"
												style="display: none;"> <img class="imag2"
												src="${webRoot}/plug-in/login/images/default_up_user.png"
												style="display: line;">
												<!-- <div class="cur">用户信息</div>--></li> 
											<li><img class="imag1"
												src="${webRoot}/plug-in/login/images/defaultdis.png"
												style="display: inline;"> <img class="imag2"
												src="${webRoot}/plug-in/login/images/default_up_district.png"
												style="display: none;">
												<!-- <div>地区信息</div>--></li> 
											<li><img class="imag1"
												src="${webRoot}/plug-in/login/images/defaultitem.png"
												style="display: inline;"> <img class="imag2"
												src="${webRoot}/plug-in/login/images/default_up_item.png"
												style="display: none;">
												<!-- <div>栏目管理</div> --></li>
												<li><img class="imag1"
												src="${webRoot}/plug-in/login/images/defaultnotic.png"
												style="display: inline;"> <img class="imag2"
												src="${webRoot}/plug-in/login/images/default_up_notice.png"
												style="display: none;">
												<!-- <div>通告管理</div> --></li>
										</ul>
									</td>
	...
	<!-- 左侧-->
	<div region="west" split="false" href="commonMainController.do?left"
		title="导航菜单" style="width: 200px; padding: 0px;"></div>
	<!-- 中间-->
	<div id="mainPanle" region="center" style="overflow: hidden;">
		<div id="maintabs" class="easyui-tabs" fit="true" border="false">
			<div class="easyui-tab" title="首页" href="commonMainController.do?home"
...
<script type="text/javascript">
	...
	function enterBefore() {
		$.ajax({
			url:"commonMainController.do?before",
		    dataType:"json",
		    type:"get",
