...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="commonLeaveController.do?save">
				...
				<tr>
					...
					<td class="value">
						<textarea class="inputxt" id="content" name="content" 
							  datatype="*" width="50%" style="width:80%;height:180px">${leavePage.content}</textarea>
