...
<html>
  <head>
    ...
    <head>
		...
		<script type="text/javascript" src="${webRoot}/js/calls/jquery-1.8.2.min.js"></script>
		...
		body {background: url(${webRoot}/files/images/calls/U8377P1276DT20140827175602.jpg) top center no-repeat;}
		...
		.wx {background: url(${webRoot}/files/images/calls/U8377P1276DT20140826100901.jpg) top center no-repeat; height: 600px;}
		body .main_btn {
   ...
   <div class="row">
	...
	<div class="col-mb-12">
      ...
      <input type="text" name="telephone" style="display:none;" id = "telephone" value="${telephone}">
  </body>
