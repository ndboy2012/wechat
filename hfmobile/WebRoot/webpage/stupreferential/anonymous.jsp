  ...
  <body>
     ...
     <div style="margin:5%;">
		...
		<div style="height:25px;width:100%"></div>
     		<div style="height:35px;">
     			<input type="text" id="telephone" class="textinputb" name="telephone" placeholder="&nbsp电话">
     		</div>
           	<div style="height:25px;width:100%"></div>
     		<div style="height:35px;">
		...
		<div style="height:50px;width:100%;"><center><p><font color="#d9d6cf">成功提交以上信息您就可以登记参与本次特惠活动<font/></p></center></div>
     		<div style="text-align:center;height:40px;"><center><button id="submitbtn" class="submitbtn" onclick="submit()">点击提交</button></center></div>
     	</div>
     </div>
